...
| p.110 本文 | scake_x_log10() | scale_x_log10() | [#12](https://github.com/uribo/kspub-dataviz/issues/12) | | 対応済み |
...
| p.275 本文 | geom_smoth() | geom_smooth() | [#16](https://github.com/uribo/kspub-dataviz/issues/16) | | 対応済み |
...
| p.298 本文 | geom_deinsity_ridges()関数 | geom_density_ridges()関数 | [#4](https://github.com/uribo/kspub-dataviz/issues/4) | | 対応済み |
| p.299 本文 | 1.5超から4.1超 | 1.5兆から4.1兆 | [#4](https://github.com/uribo/kspub-dataviz/issues/4) | | 対応済み |
| p.302 本文 | namest_to引数 | names_to引数 | [#4](https://github.com/uribo/kspub-dataviz/issues/4) | | 対応済み |
| p.338-339 図A.7, 図A.8 コード | aes(x = {{x}}, y = {{y}}) | aes_string(x = x, y = y) | [#17](https://github.com/uribo/kspub-dataviz/issues/17) | | 対応済み |
